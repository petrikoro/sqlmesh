...
def test_info(notebook, sushi_context, convert_all_html_output_to_text, get_all_html_output):
    model_count = len(sushi_context.models)
    ...
    assert get_all_html_output(output) == [
        f"<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\">Models: <span style=\"color: #008080; text-decoration-color: #008080; font-weight: bold\">{model_count}</span></pre>",
